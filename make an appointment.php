...
<body>
    ...
    <form action="appointment.php" id="ft-form" method="POST" accept-charset="UTF-8">
        <fieldset>
        ...
        <fieldset>
          ...
          <div class="two-cols">
            <label>
              Date
              <input type="date" name="Appointment_request" required>
            </label>
            <div class="inline">
              <label>
          ...
          <div class="inline">
            <label>
              <input type="radio" name="Confirmation_requested_by" value="email" checked>
              Email
            </label>
            <label>
              <input type="radio" name="Confirmation_requested_by" value="phone">
              Phone call
            </label>
          </div>
        </fieldset>
